          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2 border rounded-lg focus:ring focus:ring-blue-500 ${fieldErrors.status ? 'border-red-500' : ''}`}
              />
              {fieldErrors.status && <div className="text-red-500">{fieldErrors.status}</div>}
            </div>
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full p-2 border rounded-lg focus:ring focus:ring-blue-500 ${fieldErrors.licenseNumber ? 'border-red-500' : ''}`}
              />
              {fieldErrors.licenseNumber && <div className="text-red-500">{fieldErrors.licenseNumber}</div>}
            </div>
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full p-2 border rounded-lg focus:ring focus:ring-blue-500 ${fieldErrors.workSchedule ? 'border-red-500' : ''}`}
              />
              {fieldErrors.workSchedule && <div className="text-red-500">{fieldErrors.workSchedule}</div>}
            </div>
          </div>
