...
const TimelineItem = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn("group relative pb-6 pl-2 sm:pl-6 last:pb-2 ", className)}
      {...props}
    ></div>
  );
});
